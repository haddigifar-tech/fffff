...
-- Insert sample profile (replace with your actual user ID after registration)
-- To get your user ID, register an account first, then run: SELECT id FROM auth.users;

-- Example profile insert (replace with actual UUID from auth.users)
-- First, create a sample user ID variable for consistency
DO $$
DECLARE
    sample_user_id UUID := '12345678-1234-1234-1234-123456789012'; -- Replace this with your actual user ID
BEGIN

-- Insert sample profile with admin role
INSERT INTO profiles (
    ...
    ARRAY['Wedding', 'Pre-wedding', 'Engagement', 'Birthday', 'Corporate', 'Product'],
...
-- Insert sample additional users with different roles
INSERT INTO profiles (
    id, full_name, email, role, permissions, is_active, phone, bio, created_by
) VALUES 
(
    gen_random_uuid(),
    'Sarah Wijaya', 
    'sarah@venapictures.com', 
    'Member',
    '{"manage_projects": true, "manage_finance": true, "view_reports": true}',
    true,
    '081234567899',
    'Project Manager dan Admin Operasional',
    sample_user_id
),
(
    gen_random_uuid(),
    'Rio Pratama', 
    'rio@venapictures.com', 
    'Member',
    '{"manage_projects": true}',
    true,
    '081234567898', 
    'Editor dan Content Creator',
    sample_user_id
),
(
    gen_random_uuid(),
    'Maya Sari', 
    'maya.freelancer@email.com', 
    'Member',
...
INSERT INTO packages (id, user_id, name, price, category, physical_items, digital_items, processing_time, photographers, videographers) VALUES
('PKG001', sample_user_id, 'Paket Pernikahan Silver', 12000000, 'Pernikahan', 
 '[{"name": "Album 10R 20 halaman", "quantity": 1}, {"name": "Frame 8R", "quantity": 2}]',
...
('PKG002', sample_user_id, 'Paket Pernikahan Gold', 18000000, 'Pernikahan',
 '[{"name": "Album 10R 30 halaman", "quantity": 1}, {"name": "Frame 8R", "quantity": 3}, {"name": "USB Flashdisk", "quantity": 1}]',
...
('PKG004', sample_user_id, 'Paket Prewedding Premium', 5500000, 'Prewedding',
 '[{"name": "Album 10R 15 halaman", "quantity": 1}, {"name": "Frame 8R", "quantity": 1}, {"name": "USB Flashdisk", "quantity": 1}]',
...
INSERT INTO team_members (id, user_id, name, role, email, phone, standard_fee, no_rek, reward_balance, rating, portal_access_id) VALUES
...
('FP003', sample_user_id, 'Upgrade Peralatan', 'Tabungan untuk beli kamera baru', '📷', 'Tabungan Hadiah Freelancer', 8000000, 30000000, 'CARD002'),
...
('TXN006', sample_user_id, '2024-03-01', 'Biaya Transport Shoot Taman Mini', 200000, 'Pengeluaran', 'PRJ002', 'Transport', 'Tunai', NULL),
...
('AST003', sample_user_id, 'DJI Mini 3 Pro', 'Drone', 'Tersedia', '2023-05-10', 12000000, 10000000, 'Drone untuk aerial shot'),
...
('SOP003', sample_user_id, 'Protokol Komunikasi Klien', 'Umum',
...
INSERT INTO contracts (id, user_id, project_id, client_name, template_content, is_signed) VALUES
...
- Revisi unlimited dalam 7 hari', false),
...
-- Note: Remember to replace the sample_user_id variable value '12345678-1234-1234-1234-123456789012' 
-- with your actual user ID from auth.users table after registering an account

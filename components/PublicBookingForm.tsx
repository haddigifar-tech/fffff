        ...
        try {
            ...
            if (leadId) {
                await updateRecord('leads', leadId, {
                    ...
                    notes: `Dikonversi dari formulir booking. Klien ID: ${newClientId}`
                });
            } else {
                // Create new lead
                const newLead = {
            ...
            if (promoCodeAppliedId) {
                ...
                if (promoCode) {
                    await updateRecord('promo_codes', promoCodeAppliedId, {
                        usageCount: promoCode.usageCount + 1
                    });
                }
            }

            // Create transaction for DP
            if (dpAmount > 0) {
                ...
                // Update card balance
                await updateRecord('cards', destinationCard.id, {
